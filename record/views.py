...
def highlight(request):
    if request.method =='GET':
        ...
        with open('./data/KBO_data-master/Data/kbo_link.json','r',encoding='utf-8') as kbo_link:
            kbo_link = json.load(kbo_link)
        with open('./data/KBO_data-master/Data/kbo_comments.json','r',encoding='utf-8') as kbo_comments:
            kbo_comments = json.load(kbo_comments)
        with open('./data/KBO_data-master/Data/kbo_bonki.json','r',encoding='utf-8') as kbo_bonki:
            kbo_bonki = json.load(kbo_bonki)
